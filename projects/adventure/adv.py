...
while undiscovered:
    ...
    # navigate to that unknown

    # proceed to another depth first search

    # repeat the earlier process until there are no unknowns

    # at each step, record our steps and put them in the traversal path
